...
public class StatsModel : IDisposable
{
	...
	public ObservableProperty<StatId> IntarfaceSelectedStat = new ObservableProperty<StatId>();
	private readonly CompositeDisposable _trash = new CompositeDisposable();

	public StatsModel(PlayerData data)
	{
		_data = data;
		_trash.Retain(IntarfaceSelectedStat.Subscribe((x, y) => OnChanged?.Invoke()));
	}
